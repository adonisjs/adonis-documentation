...
class Version31 {
  ...
  constructor () {
    ...
    this.menu.load(Helpers.storagePath('menu/3.1.json'))
  }
   ...
   */
  * getDoc (permalink) {
    const contents = yield pify(fs.readFile)(Helpers.storagePath(`docs/3.1/${permalink}.html`), 'utf8')
